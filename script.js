...
},
{
  ...
  picture: "pictures/Question14.jpg"
},
{
...
},
{
  ...
  picture: "pictures/Question30.jpg"
},
{
  ...
  picture: "pictures/Question31.jpg"
},
{
...
function displayQuestion() {
  ...
  heart.setAttribute('src', "pictures/healthIcon.png");

  const negativeHeart = document.createElement('img');
  negativeHeart.className = 'lostHeart';
  negativeHeart.setAttribute('src', "pictures/healthIcon.png");

  for (let i = 0; i < health; i++) {
    healthContainer.appendChild(heart.cloneNode(true));
  }

  for (let i = 0; i < lostHealth; i++) {
    healthContainer.appendChild(negativeHeart.cloneNode(true));
  }
}
